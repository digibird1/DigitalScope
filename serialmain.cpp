...
SerialMain::SerialMain(QString portName,QObject *parent ) : QObject(parent)
{
    port = new QextSerialPort(portName, QextSerialPort::EventDriven); //"/dev/ttyACM0"
